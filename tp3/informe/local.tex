...
\indent El algoritmo de búsqueda local que implementamos parte de una solución obtenidad mediante el algoritmo contructivo goloso que desarrollamos y detallamos en la sección anterior de este Trabajo Práctico. Para generar esta solución a partir de la cual se empezará a generar otras, hará uso de un valor $porcentaje$ pasado por parámetro, que será utilizado a la hora de aplicar el algoritmo goloso.\\
\indent Una vez obtenida esta solución que será la base de las demás que se calcularán, se procede a iterar en el conjunto de las soluciones vecinas de esta primera solución $semilla$.\\
